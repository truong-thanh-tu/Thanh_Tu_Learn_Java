...
public class TestLineSub_3_1 {
	public static void main(String[] args) {
		// Test constructors and toString()
		LineSub_3_1 l1 = new LineSub_3_1(1, 2, 3, 4);
		System.out.println(l1); // toString()
		LineSub_3_1 l2 = new LineSub_3_1(new Point_3_1(5, 6), new Point_3_1(7, 8));
		System.out.println(l2);

		// Test Setters and Getters
		l1.setBegin(new Point_3_1(11, 12));
		l1.setEnd(new Point_3_1(13, 14));
		System.out.println(l1); // toString()
