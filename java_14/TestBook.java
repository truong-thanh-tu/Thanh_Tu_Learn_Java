...
public class TestBook {
	public static void main(String[] args) {
		...
		System.out.println("author's genter is : "+dummyBook.getAuthor().getGender());
		Book moreDummyBook = new Book("Java for more dumies", new Author("Peter Lee","peter@nowhere.com",'m'), 19.99, 8);
